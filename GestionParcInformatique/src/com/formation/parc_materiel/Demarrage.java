...
public class Demarrage {
	...
	public static void main(String[] args) {
		try {
			...
			pm.ajoutEquipement(new Equipement(4, "E004", "Apple", "Iphone", (Date) formatter.parse("03/10/2009"), 600,
					1, TypeEquipement.PORTABLE), 3);

			pm.ajoutEquipement(new Equipement(5, "E005", "HP", "Proliant", (Date) formatter.parse("25/02/2010"), 5000,
			...
			pm.ajoutEquipement(new Equipement(7, "E007", "HP", "Pavillon", (Date) formatter.parse("31/07/2008"), 800, 3,
			...
			pm.ajoutEquipement(new Equipement(9, "E009", "Fujitsu", "Primergy", (Date) formatter.parse("05/06/2006"),
					3500, 5, TypeEquipement.FIXE), 8);

			pm.ajoutEquipement(new Equipement(10, "E010", "Fujitsu", "Primergy", (Date) formatter.parse("05/06/2006"),
